...
Throughout this section, we will fix a $\lambda$ as in Silver's Theorem, and let $\kappa=\cf(\lambda)$. Then, by the previous Lemma, we can conclude that 
