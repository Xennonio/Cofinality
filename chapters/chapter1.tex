...
\begin{definition}{Cofinality}{cofinality}
    We will define $\cf(\alpha)$, the \lasereye{cofinality} of $\alpha$, with $\alpha$ a limit ordinal, as the smallest ordinal $\vartheta$ such that $\alpha$ is the limit of an increasing transfinite sequence $\langle\alpha_\xi:\xi<\gamma\rangle$ of length $\gamma$, i.e.
...
\begin{definition}{Regular and Singular Cardinal}{regular_singular}
    An infinite cardinal $\kappa$ is \lasereye{singular} iff there exists an increasing transfinite sequence $\langle\alpha_\xi:\xi<\gamma\rangle$ of ordinals $\alpha_\xi<\kappa$ where the length $\gamma$ is a limit ordinal less than $\kappa$, such that
    $$\kappa=\lim_{\xi\to\gamma}\alpha_\nu$$
    An infinite cardinal that is not singular is called \lasereye{regular}.
\end{definition}
