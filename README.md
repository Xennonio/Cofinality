...
## Further Directions
As you will see in the notes, the concept of cofinality leads us directly to Large Cardinal Axioms by addressing a natural question in the study of regular and singular cardinals: "does there exist an uncountable regular limit cardinal?", from here, you can read my notes on Large Cardinals (that I'm still working on). Furthermore, cofinality also naturally leads us to cardinal arithmetic, which is full of consistency results that, if you are interested, you can read more about in my notes on [Consistency Results](https://github.com/Xennonio/Consistency-Results).
